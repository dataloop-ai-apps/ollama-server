...
# docker build --no-cache -t gcr.io/viewo-g/piper/agent/ollama-server:qwen-3.5-1.0.0 -f Dockerfile .
# docker push gcr.io/viewo-g/piper/agent/ollama-server:qwen-3.5-1.0.0
