...
# docker build --no-cache -t gcr.io/viewo-g/piper/agent/runner/apps/ollama-server:gemma3-4b-1.0.0 -f Dockerfile .
# docker push gcr.io/viewo-g/piper/agent/runner/apps/ollama-server:gemma3-4b-1.0.0
